<<<<<<< HEAD:VISinger/prepare/data_vits.py
import os
import logging
import numpy as np
import librosa
...
if __name__ == "__main__":
    ...
    while True:
        ...
        s_sum = sum(scores_dur)
        l_sum = sum(labels_frames)
        if s_sum < l_sum:
        ...
        labels_slr = singInput.expandInput(labels_slr, scores_dur)
        scores_ids = singInput.expandInput(scores_ids, scores_dur)
...
if __name__ == "__main__":
    ...
    vits_file.close()
    print(len(set(all_txt)))  # 统计非重复的句子个数
>>>>>>> 86c21c0f0eaf39f3cef8ea34f0e681d7f38751a1:prepare/data_vits.py
